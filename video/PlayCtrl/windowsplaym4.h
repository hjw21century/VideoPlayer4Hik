...
#define VIDEO_YUY2          0x0301
#define VIDEO_NV12          0x0302
#define VIDEO_YV12          0x0303
...
typedef void(CALLBACK*FileEndCallback)(long nPort, void *pUser);
...
// 设置解码差错隐藏等级-默认为0：不做差错隐藏处理；暂时支持1-4等级，等级越高解码越慢。
